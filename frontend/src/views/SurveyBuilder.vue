...
export default {
  ...
  beforeMount() {
    ...
    this.updatesocket = new WebSocket(`ws://170.64.136.159:8000/ws/test/${this.$route.params.id}/`);
    this.$store.dispatch('setLockSocket', new WebSocket(`ws://170.64.136.159:8000/ws/focus/`));
